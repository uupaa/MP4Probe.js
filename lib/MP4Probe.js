...
- DiagnosticInformationObject: Object
    ...
    - playback_rate:        Number - 1.0 (typical)
    - volume:               Number - 0.0 - 1.0
    - trackLength:          UINT8 - maybe 1 or 2
    - video: VideoTrackInfoObject
        - track_ID:         UINT8
        - width:            UINT32
        - height:           UINT32
        - duration:         UINT32
...
//}@dev
    ...
    return {
        ...
        "volume":           mvhd["volume"] / 0x0100,
        "trackLength":      trak.length,
        "video":            video,
        "audio":            audio,
    };
}
...
function _getDefaultVideoInfo() { // @ret Object - { track_ID, width, height, duration, ... }
    return {
        "track_ID":         0,
        "width":            0,
        "height":           0,
...
function _getDefaultAudioInfo() { // @ret Object - { track_ID, volume, duration, ... }
    return {
        "track_ID":         0,
        "volume":           0.0,
        "duration":         0,
